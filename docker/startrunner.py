...
parser.add_argument("-s", "--sources", help="the name of the file with source urls", default="resydes/conf/discover.txt")
parser.add_argument("-c", "--config", help="the configuration filename", default="resydes/conf/config.txt", metavar="")
